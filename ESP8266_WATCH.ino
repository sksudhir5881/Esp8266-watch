 ...
 * VERSION:      v2.0 (GitHub Release)
 * AUTHOR:       Sudhir (SK Projects)
...
// Find your lat/lon here: https://www.latlong.net/
const String GEO_LAT      = "00.00"; // <--- Enter your Latitude
const String GEO_LON      = "00.00"; // <--- Enter your Longitude

// --- Hardware Pins ---
#define PIN_BUTTON        14  // D5 on NodeMCU (Button Input)
#define PIN_BATTERY       A0  // Analog Input (Battery Level)

// --- Settings ---
#define SLEEP_TIMEOUT     20000       // Screen off after 20 sec
#define WEATHER_INTERVAL  3600000     // Update weather every 1 hour
#define NTP_OFFSET        19800       // UTC +5:30 (India) = 19800 seconds
...
void setup() {
    ...
    display.setCursor(55, 55); display.print(F("v2.0"));    
    display.display();
    delay(2000); 
...
int readBatteryPercentage() {
    ...
    // Adjust these values based on your resistor divider
...
void handleOTA() {
    ...
    if(WiFi.status() == WL_CONNECTED) { 
        ArduinoOTA.setHostname("SK-Watch-v2"); ArduinoOTA.begin(); isWiFiActive = true; 
...
void renderAbout() {
    ...
    display.setCursor(10, 20); display.print(F("SK Project")); display.setCursor(10, 35); display.print(F("Version: v2.0")); display.setCursor(10, 50); display.print(F("Dev: Sudhir")); display.display();
}
...
void fetchWeatherData() {
    ...
    // Uses generic lat/lon placeholder now. Ensure user updates it!
